...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "O seu computador pode ser acedido com este ID e palavra-passe."),
        ("Password", "Password"),
        ("Ready", "Pronto"),
        ...
        ("Control Remote Desktop", "Introduza o ID HushDesk de outro equipamento"),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Direção de Sistemas e Redes - Grupo ACIN\nNa eventualidade de dúvidas ou necessidade de atualizar os dados, entre em contacto com o Gabinete de Apoio Técnico."),
        ...
        ("Language", "Idioma"),
        ("Keep HushDesk background service", "Manter o serviço do HushDesk executando em segundo plano"),
        ...
        ("powered_by_me", "Desenvolvido pelo Gruppo ACIN"),
        ...
        ("printer-{}-not-installed-tip", "A impressora HushDesk não está instalada."),
        ("printer-{}-ready-tip", "A impressora HushDesk está instalada e operacional."),
        ("Install {} Printer", "Instalar impressora HushDesk"),
